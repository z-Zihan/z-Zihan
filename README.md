...
<picture>
  ...
  <img alt="Live GitHub build signal" src="./assets/build-signal-light.svg" width="100%">
</picture>
<!-- build-signal:end -->
...
| :-- | :-- | :-- |
| **[Chorus](https://github.com/z-Zihan/Chorus)** | A local-first workspace where AI agents communicate and collaborate across CLIs, devices, and teams. | TypeScript · Tauri · Rust |
| **[Evir](https://github.com/z-Zihan/Evir)** | A clean, local-first desktop agent powered by your own models—with files, terminal, tools, and explicit user control. | TypeScript · React · Tauri |
| **[build-meta-injector](https://github.com/z-Zihan/build-meta-injector)** | One build-metadata plugin for Vite, Webpack, Rollup, Rspack, and esbuild. | JavaScript · CI/CD |
| **[awesome-skills](https://github.com/z-Zihan/awesome-skills)** | A practical collection of reusable skills for coding agents and everyday engineering workflows. | Python · Agent tooling |
...
<div align="center">
  <sub>Build with curiosity. Ship with evidence.</sub><br><br>
  <img src="https://komarev.com/ghpvc/?username=z-Zihan&color=2563eb&style=flat-square&label=profile+views" alt="Profile views">
</div>
